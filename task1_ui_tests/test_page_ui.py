...
class OperationsHelperUI(BasePage):
    ...
    def get_element_property_value(self, locator, property_name, description=None):
        if description:
            element_name = description
        else:
            element_name = locator
        ...
        if not element:
            ...
            return None
        try:
            property_value = self.get_element_property(locator, property_name)
        except():
            logging.exception(f"Get {property_name} from '{element_name}' exception")
            return None
        logging.debug(f"Got '{property_name}'='{property_value}' from '{element_name}'")
    ...
    def get_about_title_font_size(self):
        return self.get_element_property_value(TestSearchLocators.ids["LOCATOR_ABOUT_TITLE"], "font-size",
                                               "about_page_title")
    ...
    def click_about_link(self):
        self.click_element(TestSearchLocators.ids["LOCATOR_HEADER_ABOUT_LINK"], "about_header_link")
    ...
    def get_about_title_text(self):
        return self.get_text_from_element(TestSearchLocators.ids["LOCATOR_ABOUT_TITLE"], "about_page_title")
    ...
    #     return self.get_text_from_element(TestSearchLocators.ids["LOCATOR_CONTACT_US_TITLE"],
